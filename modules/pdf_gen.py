...
# --- ФУНКЦІЯ ОЦІНКИ ДЛЯ PDF ---
    ...
    recommendations_text = textwrap.dedent("""
        ...
        Високий рівень холестерину: Обов’язково ознайомтеся з рекомендаціями щодо здорового харчування. Якщо призначено статини, обов’язково приймайте їх.

        Вага: Слідкуйте за вагою. В ідеалі Ви маєте знати свій індекс маси тіла (норма < 25) та обвід талії (норма у жінок < 80 см, у чоловіків < 94 см).

        Фізична активність: 30-45 хвилин ходьби щодня або хоча б 5 разів на тиждень.

        Здорове харчування: Зменшіть споживання солі та солодкого. Пийте воду замість солодких напоїв.
        """).strip()
