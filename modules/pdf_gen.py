...
import textwrap
    ...
    recommendations_text = textwrap.dedent("""
        ...
        ТЮТЮНОПАЛІННЯ
        Усі види вживання тютюну, перш за все куріння, є доведеним чинником не лише раку легень, а й серцево-судинних захворювань. Нікотин сприяє підвищенню тиску та прискоренню пульсу; інші сполуки, що потрапляють в організм при курінні, шкодять судинам, створюють умови для утворення та швидкого росту атеросклеротичних бляшок. Ішемічна хвороба серця в 4 рази частіше виникає у курців в порівнянні з тими, хто не палить.

        ВИСОКИЙ РІВЕНЬ ХОЛЕСТЕРИНУ
        Ще одним чинником виникнення та прогресування атеросклерозу, який призводить до розвитку інфаркту та інсульту, є високий рівень холестерину. Обов’язково ознайомтеся з рекомендаціями щодо здорового харчування задля зниження рівня холестерину в крові. Якщо Вам було призначено препарати для лікування порушень ліпідного обміну, так звані статини, обов’язково приймайте їх. Це допоможе сповільнити прогресування атеросклерозу та запобігти розвитку інфаркту, інсульту, захворюванню артерій ніг.

        ВАГА
        Неодмінно слідкуйте за вагою. Надлишкова вага та ожиріння – це медична, а не естетична проблема. Вподобання щодо зовнішності можуть бути різними, а от наслідки для здоров’я зазвичай негативні. В ідеалі Ви маєте знати свій індекс маси тіла (норма < 25 кг/м2, надлишкова вага 25 – 29 кг/м2, ожиріння діагностують від 30 кг/м2) та обвід талії (норма у жінок < 80 см, у чоловіків < 94 см). Якщо Ваші показники вищі за нормативні, використовуйте поради лікаря для зниження ваги.

        ФІЗИЧНА АКТИВНІСТЬ
        Регулярна фізична активність сприяє зниженню АТ, зменшенню маси тіла, тренує серцево-судинну систему та м’язи, знімає стрес та психоемоційне напруження, покращує Ваш сон та самопочуття. Мета, до якої необхідно прагнути – 30-45 хвилин ходьби щодня або хоча б 5 разів на тиждень. Фізичні вправи з обтяженням (гирі, штанга, тренажери) можуть підвищувати АТ.
        ...
        ПСИХОЛОГІЧНИЙ СТАН
        Стрес чинить вкрай несприятливий вплив на стан здоров’я та серцево-судинні захворювання зокрема[cite: 7]. Він може бути пусковим механізмом підвищення АТ і розвитку артеріальної гіпертензії[cite: 8]. Доведено, що деякі психологічні практики на кшталт медитації, заняття йогою допомагають знизити емоційне напруження та знизити тиск[cite: 9]. Якщо відчуваєте неспроможність впоратися з емоціями самотужки, відмічаєте порушення сну, звертайтесь до лікаря для вчасної діагностики та лікування порушень ментального здоров’я[cite: 10, 11].
    """).strip()
